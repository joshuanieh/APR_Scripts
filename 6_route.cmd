...
#  Created on Mon Dec 11 19:29:57 2023                
#                                                     
#######################################################
...
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix QR_Engine_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 50 -prefix QR_Engine_postRoute -outDir timingReports
saveDesign DBS/route
